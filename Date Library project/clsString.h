...
public:
	...
	// Declaration specification for set and get
   ...
   // this function can only used with out object , like this
  //cout << clsString::InvertLetterCase('a');  
   ...
   // Enum to count Words in the string
   ...
   short  CountSpecificLetter( char Letter, bool MatchCase = true)
  {
   ...
   // this function can only used with out object because its char not string
   ...
   static vector<string> Split(string S1, string Delim)
  {
      ...
      if (S1 != "")
      {
          vString.push_back(S1); // it adds last word of the string to stack
      }
      return vString;
  }
   ...
   string TrimLeft()
 {
   ...
   string Trim()
  {
   ...
   // tow functions to join astring , this means overloading
