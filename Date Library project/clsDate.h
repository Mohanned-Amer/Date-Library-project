...
public:
	// first constroctor return the system time
	clsDate()
	{
		time_t t = time(0);
		tm* now = localtime(&t);
	...
	// forth consructor calculate date order in year
	...
	// the main function to print Date using object
   void Print()
	{
	...
	static void PrintMonthCalendar(short Month, short Year)
	{
		...
		// Index of the day starts from 0 to 6
